...
type GenesisState struct {
	...
	NextId             uint32                                   `protobuf:"varint,3,opt,name=next_id,json=nextId,proto3" json:"next_id,omitempty"`
	...
	LockedAmounts      []LockAmount                             `protobuf:"bytes,5,rep,name=locked_amounts,json=lockedAmounts,proto3" json:"locked_amounts"`
	RewardBases        []RewardBasis                            `protobuf:"bytes,6,rep,name=reward_bases,json=rewardBases,proto3" json:"reward_bases"`
	RewardAccumulators []RewardAccumulator                      `protobuf:"bytes,7,rep,name=reward_accumulators,json=rewardAccumulators,proto3" json:"reward_accumulators"`
	Unbondings         []Unbonding                              `protobuf:"bytes,8,rep,name=unbondings,proto3" json:"unbondings"`
}
...
func (m *GenesisState) GetLockedAmounts() []LockAmount {
	if m != nil {
		return m.LockedAmounts
	}
	return nil
}
...
// LockAmount tracks the amount of coins of one token denomination locked by a single address.
...
// RewardBasis tracks the value of a given locked denom's RewardAccumulator
// at the last time a specific address calculated pending rewards for it.
type RewardBasis struct {
	Address     string                                      `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	LockedDenom string                                      `protobuf:"bytes,2,opt,name=locked_denom,json=lockedDenom,proto3" json:"locked_denom,omitempty"`
...
func (m *RewardBasis) GetLockedDenom() string {
	if m != nil {
...
// of rewards that a single unit of locked_denom would have accumulated if it was
// locked since genesis.
type RewardAccumulator struct {
	LockedDenom string                                      `protobuf:"bytes,1,opt,name=locked_denom,json=lockedDenom,proto3" json:"locked_denom,omitempty"`
	RewardBasis github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=reward_basis,json=rewardBasis,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"reward_basis"`
}
...
func (m *RewardAccumulator) GetLockedDenom() string {
	if m != nil {
		return m.LockedDenom
	}
	return ""
...
var fileDescriptor_3f117566517b8062 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LockedAmounts) > 0 {
		for iNdEx := len(m.LockedAmounts) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LockedAmounts[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *RewardBasis) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LockedDenom) > 0 {
		...
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.LockedDenom)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockedAmounts", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LockedAmounts = append(m.LockedAmounts, LockAmount{})
			if err := m.LockedAmounts[len(m.LockedAmounts)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
